...
{
    public partial class chaveLigaçãoBd : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "c", "e1f273ca-7bcb-428c-9bb9-e37ad2b32c58", "Cliente", "CLIENTE" },
                    { "f", "c8e5e6e7-ace0-4a31-84ed-5b36bd681530", "Funcionario", "FUNCIONARIO" },
                    { "g", "43e76dc1-8338-437f-907d-c0b1dc574532", "Gestor", "GESTOR" }
                });

            migrationBuilder.InsertData(
                table: "Clientes",
                columns: new[] { "Id", "Apelido", "Cidade", "CodPostal", "Email", "Morada", "NrContribuinte", "NrTelemovel", "País", "PrimeiroNome", "UserId" },
                values: new object[] { 1, "Mendes", "Santo António dos Cavaleiros", "2660-284", "goncalomendes@sapo.pt", "Rua...", "412414141", "941941941", "Portugal", "Gonçalo", null });
